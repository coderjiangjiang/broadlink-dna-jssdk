...
exports.cordovaReadyOnlinePromise = exports.deviceInfoPromise = exports.dnaControl = exports.callNative = exports.isIOS = void 0;
const ismobilejs_1 = __importDefault(require("ismobilejs"));
exports.isIOS = (0, ismobilejs_1.default)(window.navigator).apple.device;
...
const cordovaReadyOnlinePromise = new Promise(function (resolve, reject) {
    ...
    const script = document.createElement('script');
    script.src = `./cordova/${exports.isIOS ? 'ios' : 'android'}/cordova.min.js`;
    document.getElementsByTagName('head')[0].appendChild(script);
    document.addEventListener('deviceready', () => {
...
exports.cordovaReadyOnlinePromise = cordovaReadyOnlinePromise;
const deviceInfoPromise = (function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield _cordovaReadyPromise;
        const info = yield _callNative('deviceinfo');
        const device = {};
...
exports.deviceInfoPromise = deviceInfoPromise;
...
exports.callNative = callNativeSafe;
const dnaControl = function (ctrlData, commandStr = 'dev_ctrl') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield _callNative('devicecontrol', [device.deviceID, device.subDeviceID, ctrlData, commandStr, time]);
